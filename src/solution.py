...
household_predictions.to_csv(f"{PRED_DIR}/predicted_household_consumption.csv", index=False)
poverty_df.to_csv(f"{PRED_DIR}/predicted_poverty_distribution.csv", index=False)

import zipfile
with zipfile.ZipFile(f"{PRED_DIR}/submission.zip", 'w', zipfile.ZIP_DEFLATED) as zf:
    zf.write(f"{PRED_DIR}/predicted_household_consumption.csv", "predicted_household_consumption.csv")
    zf.write(f"{PRED_DIR}/predicted_poverty_distribution.csv", "predicted_poverty_distribution.csv")
